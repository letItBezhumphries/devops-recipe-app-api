...
########################################################## 
# Policy for Terraform backend to S3 and DynamoDB access - generate json policy #
##########################################################
...
data "aws_iam_policy_document" "ecr" {
  ...
  statement {
    ...
    resources = [
      aws_ecr_repository.demoapp.arn,
...
resource "aws_iam_service_linked_role" "ecs" {
  ...
  description      = "Service-linked role for Amazon ECS Service"
}
