...
##########################################################################
# Endpoints that allow ECS to access ECR, CloudWatch and Systems Manager #
##########################################################################
...
###########################################################
# Endpoint to connect to dkr - docker container registry #
###########################################################
...
######################################
# Endpoint to connect to CloudWatch #
######################################
...
##########################################
# Endpoint to connect to Systems Manager #
##########################################
...
##################################################
# Gateway Endpoint to connect to store images on s3 #
##################################################
